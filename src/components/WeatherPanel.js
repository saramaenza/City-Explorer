                ...
                <div className="xl:w-1/4 flex justify-center xl:justify-start items-center">
                  <div className="px-3 flex flex-col items-center">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        <div className="text-2xl sm:text-2xl md:text-3xl lg:text-4xl font-medium text-gray-900 font-work">
                          {Math.round(weather.main.temp)}°
                        </div>
                        <div className="text-base sm:text-base md:text-lg lg:text-lg text-gray-900 capitalize font-work">
                          {weather.weather[0].description}
                        </div>
                      </div>
                    </div>
                    <div className="mt-1 flex gap-4 text-sm sm:text-sm md:text-base lg:text-base text-gray-700 font-work">
                  ...
                  <div className="px-1 pt-2 mb-2 w-full">
                    <div className="grid grid-cols-3 sm:grid-cols-5 gap-2">
                      {forecast.map((item, idx) => (
                        ...
                        >
                          <div className="text-sm sm:text-sm md:text-base lg:text-base text-gray-800 font-work mb-1">
                          ...
                          <div className="text-sm sm:text-sm md:text-base lg:text-base font-medium text-gray-800 font-work">
