...
function SearchInput({ onSelect }) {
  ...
  return (
    <form className="max-w-md mx-auto mt-5" autoComplete="off" ref={inputRef} onSubmit={handleSearch}>
      <div className="relative">
        <div className="flex">
          <input 
            type="search" 
            id="search" 
            className="font-work block w-md p-3 pl-5 bg-white border border-gray-100 text-gray-900 text-lg rounded-l-2xl shadow placeholder:text-gray-500 
